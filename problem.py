...
class Problem_multi_ElementWise(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        diversity_score = -np.mean(np.sum(self.current_population != x, axis=1)) # negative because pymoo minimize, choose the lower value
...
class Problem_multi_no_const_ElementWise(ElementwiseProblem):
    def __init__(self, trace_length, encoder, d4py, initial_population, xl,xu, event_log, dataframe):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        out["F"] = [diversity_score, constraint_score]
